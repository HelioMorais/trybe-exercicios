// Você ficou responsável por conferir a lista de pessoas convidadas de uma festa de casamento e precisa verificar 
// se o nome da pessoa está ou não na lista. Para isso, você deve utilizar o código abaixo e desenvolver sua lógica a partir dele:
...
const people = [
    ...
    const verifyAges = (arr, minimoAge) => {
        return arr.every((person) => person.age >= minimoAge);
    }
